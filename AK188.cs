    ...
    class AK188 : AdvancedGunBehaviour
    {
        ...
        private void Transforming(PlayerController player)
        {
            if(player.CurrentGun == this)
            {
                ...
                if (Tracker == 55)
                {
                    Gun gun = ETGMod.Databases.Items["cel:infinite_ak"] as Gun;
                    player.inventory.AddGunToInventory(gun, true);
                    player.inventory.DestroyGun(ETGMod.Databases.Items["cel:ak_188"] as Gun);
                }
            }            
        }
        ...
        public override void OnPostFired(PlayerController player, Gun gun)
        {
            ...
            float v3 = UnityEngine.Random.Range(-4f, 4f);
            ...
            GameObject gameObject3 = SpawnManager.SpawnProjectile(projectile3.gameObject, base.Owner.sprite.WorldCenter, Quaternion.Euler(0f, 0f, (base.Owner.CurrentGun == null) ? 0f : base.Owner.CurrentGun.CurrentAngle - 90 + v2), true);
            ...
            GameObject gameObject4 = SpawnManager.SpawnProjectile(projectile4.gameObject, base.Owner.sprite.WorldCenter, Quaternion.Euler(0f, 0f, (base.Owner.CurrentGun == null) ? 0f : base.Owner.CurrentGun.CurrentAngle + 135 + v3), true);
