...
namespace Items
{
    internal class ChildrenOKaliberSynergies
    {
        ...
        public class ExplosiveRebarSyn : AdvancedSynergyEntry
        {

            public ExplosiveRebarSyn()
            {
                this.NameKey = "Explosive Rebar";
                this.MandatoryGunIDs = new List<int>
                {
                    ETGMod.Databases.Items["rebar_crossbow"].PickupObjectId,
                };
                this.MandatoryItemIDs = new List<int>
                {
                    259
