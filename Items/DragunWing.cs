...
namespace Items
{
    class DragunWing : PassiveItem
    {
        ...
        public override void Pickup(PlayerController player)
        {
          ...
          //  if (player.HasPickupID(ETGMod.Databases.Items["Dragun Heart"].PickupObjectId) && player.HasPickupID(ETGMod.Databases.Items["Dragun Skull"].PickupObjectId) && player.HasPickupID(ETGMod.Databases.Items["Dragun Claw"].PickupObjectId))
          //  {
