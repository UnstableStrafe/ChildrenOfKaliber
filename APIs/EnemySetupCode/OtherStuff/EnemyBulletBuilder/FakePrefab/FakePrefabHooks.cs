...
{
    public static class BulletBuilderFakePrefabHooks
    {
        public static void Init()
        {
            ...
            Hook silentItemAcquireHook = new Hook(
                ...
                typeof(BulletBuilderFakePrefabHooks).GetMethod("AcquirePassiveItemPrefabDirectly")
            );

            //Same deal but for passives
            Hook activePickupHook = new Hook(
                typeof(PlayerItem).GetMethod("Pickup"),
                typeof(BulletBuilderFakePrefabHooks).GetMethod("ActivePickup")
            );
            ...
            Hook instantiateOPI = new Hook(
                ...
                typeof(BulletBuilderFakePrefabHooks).GetMethod("InstantiateOPI")
            );
            ...
            Hook instantiateOP = new Hook(
                ...
                typeof(BulletBuilderFakePrefabHooks).GetMethod("InstantiateOP")
            );
            ...
            Hook instantiateOPR = new Hook(
                ...
                typeof(BulletBuilderFakePrefabHooks).GetMethod("InstantiateOPR")
            );
            ...
            Hook instantiateOPRP = new Hook(
                ...
                typeof(BulletBuilderFakePrefabHooks).GetMethod("InstantiateOPRP")
            );
        }
        ...
        {
            bool isFake = BulletBuilderFakePrefab.IsFakePrefab(item.gameObject);
            if (isFake)
        ...
        {
            bool isFake = BulletBuilderFakePrefab.IsFakePrefab(self.gameObject);
            if (isFake)
        ...
        {
            return BulletBuilderFakePrefab.Instantiate(original, orig(original, parent, instantiateInWorldSpace));
        }

        public static Object InstantiateOP(Func<Object, Transform, Object> orig, Object original, Transform parent)
        {
            return BulletBuilderFakePrefab.Instantiate(original, orig(original, parent));
        }

        public static Object InstantiateO(Func<Object, Object> orig, Object original)
        {
            return BulletBuilderFakePrefab.Instantiate(original, orig(original));
        }
        ...
        {
            return BulletBuilderFakePrefab.Instantiate(original, orig(original, position, rotation));
        }
        ...
        {
            return BulletBuilderFakePrefab.Instantiate(original, orig(original, position, rotation, parent));
        }
