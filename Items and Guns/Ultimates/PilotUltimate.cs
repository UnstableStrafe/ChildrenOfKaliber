...
namespace Items
{
    class PilotUltimate : PassiveItem
    {
        public static void Init()
        {
            string itemName = "Pilot Ultimate";

            string resourceName = "Items/Resources/Ultimates/Pilot/pilot_ultimate.png";

            GameObject obj = new GameObject(itemName);

            var item = obj.AddComponent<PilotUltimate>();

            ItemBuilder.AddSpriteToObject(itemName, resourceName, obj);

            string shortDesc = "";
            string longDesc = "Summons a horde of wolves to attack enemies for a few seconds.\nHold <Switch Active Item Up> to bring up the selector for the ultimate. The ultimate ability will need to be recharged after use.";
        ...
        private static void SetupSprites()
        {
            ...
            VFXCollection = SpriteBuilder.ConstructCollection(VFXScapegoat, "Pilot_Ability_VFX_Collection");
            UnityEngine.Object.DontDestroyOnLoad(VFXCollection);

            id1 = SpriteBuilder.AddSpriteToCollection("Items/Resources/Ultimates/Pilot/pilot_ultimate_charge_001", VFXCollection);
            id2 = SpriteBuilder.AddSpriteToCollection("Items/Resources/Ultimates/Pilot/pilot_ultimate_charge_002", VFXCollection);
            id3 = SpriteBuilder.AddSpriteToCollection("Items/Resources/Ultimates/Pilot/pilot_ultimate_charge_003", VFXCollection);
            id4 = SpriteBuilder.AddSpriteToCollection("Items/Resources/Ultimates/Pilot/pilot_ultimate_charge_004", VFXCollection);
            id5 = SpriteBuilder.AddSpriteToCollection("Items/Resources/Ultimates/Pilot/pilot_ultimate_charge_005", VFXCollection);
            id6 = SpriteBuilder.AddSpriteToCollection("Items/Resources/Ultimates/Pilot/pilot_ultimate_charge_006", VFXCollection);
            id7 = SpriteBuilder.AddSpriteToCollection("Items/Resources/Ultimates/Pilot/pilot_ultimate_charge_007", VFXCollection);
            id8 = SpriteBuilder.AddSpriteToCollection("Items/Resources/Ultimates/Pilot/pilot_ship_001", VFXCollection);
        }
